...
void ABasePawn::HandleDestruction()
{
	...
	if (DeathCamereShakeClass)
	{
		GetWorld()->GetFirstPlayerController()->ClientStartCameraShake(DeathCamereShakeClass);
	}
}
...
void ABasePawn::Fire()
{
	...
	//DrawDebugSphere(GetWorld(), ProjectileSpawnPointLocation, 10.f, 12, FColor::Green, false, 3.f);
